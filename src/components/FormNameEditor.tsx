// src/components/FormNameEditor.tsx
...
const PositionedMenu = ({ triggerRef, onRename, onClose }: {
  // FIX: The ref passed from useRef(null) can be null initially.
  // The type is updated to correctly reflect this.
  ...
  useLayoutEffect(() => {
    // The check for `triggerRef.current` already handles the null case safely.
